...
void init_argumet(t_data *cub) // init the data structure
{
	...
	cub->map->brut_map[0] = strdup("1de456789abcdefghijklmnop");
	cub->map->brut_map[1] = strdup("2000000000000000000000004");
	cub->map->brut_map[2] = strdup("2000000000000000000000004");
	cub->map->brut_map[3] = strdup("2000000000000000000000004");
	cub->map->brut_map[4] = strdup("2000000000000000000000004");
	cub->map->brut_map[5] = strdup("2000000000000000000000004");
